        ...
        <div className="space-y-6">
          {education.map((edu) => (
            <Reveal key={edu.institution}>
              <SpotlightCard className="p-8 md:p-12" data-cursor="hover">
                ...
                <div className="relative flex flex-col justify-between gap-10 lg:flex-row lg:items-center">
                  <div className="flex-1">
                    {edu.logo && (
                      <div className="mb-6 inline-flex items-center rounded-2xl bg-white px-5 py-4 shadow-lg shadow-black/30 ring-1 ring-white/10">
                        <img
                          src={edu.logo}
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <span className="animate-pulse rounded-full bg-brand px-3 py-1 text-[10px] font-bold uppercase tracking-[0.15em] text-ink-950">
                        {edu.status}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col items-start lg:items-end">
                    ...
                    <div className="relative">
                      ...
                      <motion.div
                        ...
                        className="relative pr-[0.08em] font-display text-6xl font-bold tracking-tight text-gradient-brand sm:text-7xl md:text-8xl"
                      >
                        {edu.score}
                      </motion.div>
                    </div>
