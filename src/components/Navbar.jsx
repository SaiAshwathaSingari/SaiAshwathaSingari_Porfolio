      ...
      >
        <nav className="container-x flex items-center justify-between">
          <button
            ...
            data-cursor="hover"
          >
            <span className="grid h-9 w-9 place-items-center rounded-lg bg-brand font-display text-lg font-bold italic text-ink-950 transition-transform group-hover:-rotate-6">
              S
            </span>
            <span className="hidden font-display text-sm font-semibold uppercase tracking-[0.2em] sm:block">
              Sai Ashwatha
            </span>
          </button>
              ...
              <ul className="flex flex-col gap-1">
                {navLinks.map((link, i) => (
                  ...
                  >
                    <button
                      onClick={() => go(link.href)}
                      className="font-display text-4xl font-bold uppercase italic tracking-tightest text-zinc-200 transition-colors active:text-brand sm:text-5xl"
                    >
                      {link.name}
                    </button>
                  </motion.li>
