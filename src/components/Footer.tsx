...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/[0.08] pt-20 pb-10">
      <div className="grid-dots pointer-events-none absolute inset-0 opacity-40" />
      <div className="container-x relative">
        <div className="flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
          <div>
            <p className="eyebrow mb-5">
              <span className="h-px w-8 bg-brand" /> Let's build something
            </p>
            <h2 className="font-display text-[13vw] font-bold tracking-tightest leading-[0.9] sm:text-6xl md:text-7xl">
