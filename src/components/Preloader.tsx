      ...
      <div className="relative flex flex-col items-center px-6">
        ...
        <div className="overflow-hidden">
          <motion.h1
            ...
            className="text-center font-display text-4xl font-bold tracking-tightest text-white sm:text-6xl"
          >
            {profile.fullName}
          </motion.h1>
        </div>

        {/* Progress line with a glowing orb */}
        <div className="mt-12 w-[min(82vw,380px)]">
          <div className="relative h-px w-full bg-white/10">
            ...
            />
            <div
              className="absolute top-1/2 h-3 w-3 -translate-y-1/2 rounded-full bg-brand shadow-[0_0_14px_3px_rgba(124,255,79,0.6)]"
              style={{ left: `calc(${count}% - 6px)` }}
            />
          </div>
